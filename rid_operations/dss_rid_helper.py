...
class RemoteIDOperations:
    ...
    def create_dss_isa(
        ...
        try:
            ...
            dss_isa_create_url = (
                self.dss_base_url + "v1/dss/identification_service_areas/" + new_isa_id
            )
            ...
            try:
                ...
                service_area = IdentificationServiceArea(
                    flights_url=dss_response_service_area["flights_url"],
                    owner=dss_response_service_area["owner"],
                    time_start=dss_response_service_area["time_start"],
                    time_end=dss_response_service_area["time_end"],
    ...
    def create_dss_subscription(
        ...
        try:
            ...
            dss_subscription_url = (
                self.dss_base_url + "v1/dss/subscriptions/" + new_subscription_id
            )
