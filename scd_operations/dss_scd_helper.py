            ...
            for current_uss_operational_intent_detail in all_uss_operational_intent_details:
                ...
                try:
                    ...
                    if uss_operational_intent_request.status_code ==200:
                        ...
                        cur_op_int_details = OpInttoCheckDetails(shape= minimum_rotated_rect, ovn = op_int_ref['ovn'])
    ...
    def create_and_submit_operational_intent_reference(self, state:str, priority:str, volumes:List[Volume4D], off_nominal_volumes:List[Volume4D]) -> OperationalIntentSubmissionStatus:        
        ...
        if all_existing_operational_intent_details:
            ...
            if priority ==100:                
                ...
                is_conflicted = rtree_helper.check_polygon_intersection(op_int_details = all_existing_operational_intent_details, polygon_to_check=ind_volumes_polygon)
